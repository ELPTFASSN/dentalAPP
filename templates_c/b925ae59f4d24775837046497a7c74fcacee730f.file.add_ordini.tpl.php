<?php /* Smarty version Smarty-3.1.19, created on 2015-10-19 18:47:35
         compiled from "./templates/add_ordini.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2078090245623c47d29b1a8-70541483%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b925ae59f4d24775837046497a7c74fcacee730f' => 
    array (
  ...
  'nocache_hash' => '2078090245623c47d29b1a8-70541483',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5623c47d30b505_57379009',
  'variables' => 
  array (
    'error' => 0,
    'aziende' => 0,
...
<?php if ($_valid && !is_callable('content_5623c47d30b505_57379009')) {function content_5623c47d30b505_57379009($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_calculate_age')) include '/var/www/vhosts/intervolutions.com/pruebas.intervolutions.com/alfaone/libs/plugins/modifier.calculate_age.php';
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading"><h3 class="panel-title">Dati del trattamento</h3></div>
...
ordini.php" method="post" name="aggiorna_profilo_medico">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Sceglie la azienda</label>
                                        <select name="azienda" class="select2" data-placeholder="Seleziona tipologia...">
                                            <option></option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="paziente" class="select2" data-placeholder="Seleziona tipologia...">
                                            ...
                                            <?php  $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['key']->_loop = false;
 $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['pazienti']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['key']->key => $_smarty_tpl->tpl_vars['key']->value) {
$_smarty_tpl->tpl_vars['key']->_loop = true;
 $_smarty_tpl->tpl_vars['value']->value = $_smarty_tpl->tpl_vars['key']->key;
?>
...
"><?php echo $_smarty_tpl->tpl_vars['key']->value['nome'];?>
 ...
 - Et&agrave;: <?php echo smarty_modifier_calculate_age($_smarty_tpl->tpl_vars['key']->value['dataNascita']);?>
 anni - Citt&agrave;: <?php echo $_smarty_tpl->tpl_vars['key']->value['citta'];?>
</option>
                                            <?php } ?>
                                        </select>
                                    </div>
    ...
    <area alt="" title="" id="38" href="javascript:{}" shape="poly" coords="319,57,313,53,312,49,315,39,319,30,322,27,331,26,338,25,346,30,349,35,349,43,346,52,343,59,338,62" />
        ...
        <input type="hidden" id="38b" name="38" value="false" />
                                ...
                                <div class="clearfix"></div>
                                <p><hr></p>
                                <div class="col-md-12 text-right"><a href="ordini.php" class="btn btn-danger btn-lg">Cancella <i class="fa fa-times"></i></a> <button class="btn btn-primary btn-lg">Invia <i class="fa fa-check"></i></button></div>
                            </form>
                        </div>
