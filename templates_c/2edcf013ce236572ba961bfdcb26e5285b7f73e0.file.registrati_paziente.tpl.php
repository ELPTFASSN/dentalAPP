<?php /* Smarty version Smarty-3.1.19, created on 2016-02-01 22:19:09
         compiled from "./templates/registrati_paziente.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17118674675652cfbeb4e4c0-18037478%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2edcf013ce236572ba961bfdcb26e5285b7f73e0' => 
    array (
  ...
  'nocache_hash' => '17118674675652cfbeb4e4c0-18037478',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5652cfbebc3669_55680175',
  'variables' => 
  array (
    'oPaziente' => 0,
    'regioni' => 0,
...
<?php if ($_valid && !is_callable('content_5652cfbebc3669_55680175')) {function content_5652cfbebc3669_55680175($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/vhosts/beecloud.it/easysmile.beecloud.it/panel/libs/plugins/modifier.date_format.php';
...
<?php } else { ?>gg/mm/aaaa<?php }?>" id="datepicker" required>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-lg required" data-mask="999?9999999" name="telefonoMobile" placeholder="Es. 3334445555" value="<?php if (isset($_smarty_tpl->tpl_vars['oPaziente']->value->telefonoMobile)) {?><?php echo $_smarty_tpl->tpl_vars['oPaziente']->value->telefonoMobile;?>
<?php }?>" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
