<?php /* Smarty version Smarty-3.1.19, created on 2015-11-17 16:26:56
         compiled from "./templates/modifica_riepilogo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19299827515641c5240e0ce6-54987674%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3519d0a5c2e5e965f209073c5842fbb166461f53' => 
    array (
  ...
  'nocache_hash' => '19299827515641c5240e0ce6-54987674',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5641c5241e8f82_19175361',
  'variables' => 
  array (
    'error' => 0,
    'trattamento' => 0,
...
<?php if ($_valid && !is_callable('content_5641c5241e8f82_19175361')) {function content_5641c5241e8f82_19175361($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/vhosts/beecloud.it/easysmile.beecloud.it/libs/plugins/modifier.date_format.php';
...
: <span class="pull-right text-big"><small><?php echo $_smarty_tpl->tpl_vars['trattamento']->value['masSup']+$_smarty_tpl->tpl_vars['trattamento']->value['masInf'];?>
 ...
 &euro;</span></li>
                                <li class='list-group-item penultimo'>Acconto prescrizione: <span class="pull-right text-big">- <?php echo number_format($_smarty_tpl->tpl_vars['acconto']->value,2,",",".");?>
 &euro;</span></li>
                    ...
                    <div class="panel panel-border panel-primary">
                        ...
                        <div class="panel-body">
                            <ul class="list-group">
                                ...
                                <?php if (!isset($_smarty_tpl->tpl_vars['tercereja']->value)) {?><li class='list-group-item penultimo'>Prezzo abbonato secondo range: <span class="pull-right text-big"><?php echo $_smarty_tpl->tpl_vars['sinsup']->value+$_smarty_tpl->tpl_vars['sininf']->value;?>
 x <?php echo number_format($_smarty_tpl->tpl_vars['secondo']->value,2,",",".");?>
 &euro;</span></li><?php }?>
                                 <?php if (isset($_smarty_tpl->tpl_vars['terzo']->value)) {?><li class='list-group-item penultimo'>Prezzo abbonato terzo range: <span class="pull-right text-big"><small><?php echo $_smarty_tpl->tpl_vars['mastot']->value-$_smarty_tpl->tpl_vars['tercereja']->value-$_smarty_tpl->tpl_vars['frazionamenti']->value['max'];?>
 x </small><?php echo number_format($_smarty_tpl->tpl_vars['terzo']->value,2,",",".");?>
 &euro;</span></li><?php }?>
                  ...
                  <?php if ($_smarty_tpl->tpl_vars['trattamento']->value['estado']=="1") {?>              
...
">
                                    <input type="hidden" name="pastaunica" value="">
                                    <input type="hidden" name="fraccionado" value="">
