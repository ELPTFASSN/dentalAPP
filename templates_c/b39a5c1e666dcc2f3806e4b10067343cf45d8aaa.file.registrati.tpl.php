<?php /* Smarty version Smarty-3.1.19, created on 2016-02-01 21:40:50
         compiled from "./templates/registrati.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1530074435652cfba303985-21354538%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b39a5c1e666dcc2f3806e4b10067343cf45d8aaa' => 
    array (
  ...
  'nocache_hash' => '1530074435652cfba303985-21354538',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5652cfba36ef68_33862632',
  'variables' => 
  array (
    'oMedico' => 0,
    'regioni' => 0,
...
<?php if ($_valid && !is_callable('content_5652cfba36ef68_33862632')) {function content_5652cfba36ef68_33862632($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("header_public.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
<?php }?>">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required="required" class="form-control input-lg required" data-mask="999?99999999" name="telefono" placeholder="Es. 06.12255555 " value="<?php if (isset($_smarty_tpl->tpl_vars['oMedico']->value->telefono)) {?><?php echo $_smarty_tpl->tpl_vars['oMedico']->value->telefono;?>
<?php }?>">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control input-lg required" data-mask="999?9999999" name="telefonoMobile" placeholder="Es. 3334445555" value="<?php if (isset($_smarty_tpl->tpl_vars['oMedico']->value->telefonoMobile)) {?><?php echo $_smarty_tpl->tpl_vars['oMedico']->value->telefonoMobile;?>
<?php }?>">
                                            </div>
                                        </div>
...
<?php }?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required="required" class="form-control input-lg required" name="partitaIVA" data-mask="9?999999999" placeholder="Es. 321654987" value="<?php if (isset($_smarty_tpl->tpl_vars['oMedico']->value->partitaIVA)) {?><?php echo $_smarty_tpl->tpl_vars['oMedico']->value->partitaIVA;?>
<?php }?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required="required" class="form-control input-lg required" name="numeroAlbo" data-mask="9?999999999" placeholder="Es. 321654987" value="<?php if (isset($_smarty_tpl->tpl_vars['oMedico']->value->numeroAlbo)) {?><?php echo $_smarty_tpl->tpl_vars['oMedico']->value->numeroAlbo;?>
<?php }?>">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
