<?php /* Smarty version Smarty-3.1.19, created on 2016-02-07 16:44:49
         compiled from "./templates/add_ordini.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11224609435652cfcdda1c92-19708850%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dc85115642f69f245f74f9fc7065d858204a0ee0' => 
    array (
      0 => './templates/add_ordini.tpl',
      1 => 1454859760,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11224609435652cfcdda1c92-19708850',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5652cfcde08f57_51674591',
  'variables' => 
  array (
    'error' => 0,
    'aziende' => 0,
...
<?php if ($_valid && !is_callable('content_5652cfcde08f57_51674591')) {function content_5652cfcde08f57_51674591($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/vhosts/beecloud.it/easysmile.beecloud.it/panel/libs/plugins/function.math.php';
...
ordini.php" method="post" name="aggiorna_profilo_medico" enctype="multipart/form-data">
                                                                        ...
                                                                        <table class="table m-t-30">
                                                                            ...
                                                                            <tbody>
                                                                                    ...
                                                                                    <tr class="odd">
                                                                                        ...
                                                                                        <td>
                                                                                            <?php echo number_format($_smarty_tpl->tpl_vars['acconto']->value,2,",",".");?>
 &euro;
                                                                                        </td>
                                                                                        <td><?php echo number_format($_smarty_tpl->tpl_vars['acconto']->value,2,",",".");?>
 &euro;</td>
                                                                                    </tr>
                                                                                    <?php if (isset($_smarty_tpl->tpl_vars['spedizione']->value)) {?>
                                                                                    <tr class="odd">
                                                                                        ...
                                                                                        <td>
                                                                                            <?php echo number_format($_smarty_tpl->tpl_vars['spedizione']->value,2,",",".");?>
 &euro;
                                                                                        </td>
                                                                                        <td><?php echo number_format($_smarty_tpl->tpl_vars['spedizione']->value,2,",",".");?>
 &euro;</td>
                                                                                    </tr>
                                                                               ...
                                                                               <tr class="odd">
                                                                                        ...
                                                                                        <td></td>
<?php if ($_SESSION['utente']['IVASINO']) {?>
                                                                                        <td>
                                                                                        IVA <?php echo $_SESSION['utente']['IVA'];?>
%
                                                                                        </td>
                                                                                        
                                                                                        <td><?php echo smarty_function_math(array('equation'=>"x*y",'x'=>$_smarty_tpl->tpl_vars['prezzo']->value['totale'],'y'=>0.22,'format'=>"%.2f",'assign'=>"iva"),$_smarty_tpl);?>
<?php echo $_smarty_tpl->tpl_vars['iva']->value;?>
 &euro;</td><?php }?>
                                                                                    </tr>
                                                                            </tbody>
                                                                        </table>
                                ...
                                <h3 class='text-right'>Prezzo acconto della prescrizione: <strong><?php if ($_SESSION['utente']['IVASINO']) {?><?php echo smarty_function_math(array('equation'=>"x*y",'x'=>$_smarty_tpl->tpl_vars['prezzo']->value['totale'],'y'=>1.22,'format'=>"%.2f",'assign'=>"totall"),$_smarty_tpl);?>
<?php echo $_smarty_tpl->tpl_vars['totall']->value;?>
<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['prezzo']->value['totale'];?>
<?php }?> &euro; &nbsp;&nbsp;&nbsp;</strong> </h3>
                                <p><hr></p>
