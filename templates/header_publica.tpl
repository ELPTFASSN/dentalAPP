...
<html>
    <head>
        ...
        <title>Log In alla piattaforma di Dental Italia Group</title>
    ...
    <body class=fixed-left>
        <div id=wrapper>
			...
			<li><a href="http://showcase.intervolutions.com/dentisti/panel/">Login</a></li>
   			<li><a href="http://showcase.intervolutions.com/dentisti/panel/registrati.php">Registrati</a></li>
