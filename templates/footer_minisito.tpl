...
<script src="http://maps.google.com/maps/api/js?sensor=true"></script>
    ...
    GoogleMap.prototype.createBasic = function($container) {
        ...
        GMaps.geocode({
  address: "{$azienda['indirizzo']} {$azienda['numero']}, {$azienda['CAP']} {$azienda['nomecomune']} Italia",
  callback: function(results, status) {
    if (status == 'OK') {
      ...
      map.drawOverlay({
        ...
        content: '<div class="gmaps-overlay"><strong>{$azienda['denominazione']} </strong><br><small>{$azienda['indirizzo']} {$azienda['numero']}, {$azienda['CAP']} {$azienda['nomecomune']}</small><div class="gmaps-overlay_arrow above"></div></div>',
        verticalAlign: 'top',
