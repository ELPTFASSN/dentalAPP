                                    ...
                                    <section>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input required="required" type="text" class="form-control input-lg " data-mask="?9999999999" name="partitaIVAAzienda" placeholder="ES. 12345678987" value="{if isset($oMedico->partitaIVA)}{$oMedico->partitaIVA}{/if}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input required="required" type="text" class="form-control input-lg" data-mask="?9999999999" name="telefonoAzienda" placeholder="ES. 077411111111" value="{if isset($oMedico->numeroAlbo)}{$oMedico->numeroAlbo}{/if}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Cellulare rappresentante <span class="text-danger">*</span></label>
                                                <input required="required" type="text" class="form-control input-lg " name="telefonoMobileAzienda" data-mask="?9999999999" placeholder="ES. 3334445555" value="{if isset($oMedico->numeroAlbo)}{$oMedico->numeroAlbo}{/if}">
                                            </div>
                                        </div>
                                    </section>
